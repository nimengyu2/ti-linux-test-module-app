...
// nmy add define macro
/*syscfg0 register address*/
#define SYSCFG0_BASE 		  IO_ADDRESS(0x01C14000)
#define REVID                 IO_ADDRESS(0x01C14000) 
#define DIEIDR0               IO_ADDRESS(0x01C14008) 
#define DIEIDR1               IO_ADDRESS(0x01C1400C) 
#define DIEIDR2               IO_ADDRESS(0x01C14010) 
#define DIEIDR3               IO_ADDRESS(0x01C14014) 
#define DEVIDR0               IO_ADDRESS(0x01C14018) 
#define BOOTCFG               IO_ADDRESS(0x01C14020) 
#define KICK0R                IO_ADDRESS(0x01C14038) 
#define KICK1R                IO_ADDRESS(0x01C1403C) 
#define HOST0CFG              IO_ADDRESS(0x01C14040) 
#define IRAWSTAT              IO_ADDRESS(0x01C140E0) 
#define IENSTAT               IO_ADDRESS(0x01C140E4) 
#define SYSCFG0_IENSET        IO_ADDRESS(0x01C140E8) 
#define SYSCFG0_IENCLR        IO_ADDRESS(0x01C140EC) 
#define SYSCFG0_EOI           IO_ADDRESS(0x01C140F0) 
#define SYSCFG0_FLTADDRR      IO_ADDRESS(0x01C140F4) 
#define SYSCFG0_FLTSTAT       IO_ADDRESS(0x01C140F8) 
#define SYSCFG0_MSTPRI0       IO_ADDRESS(0x01C14110) 
#define SYSCFG0_MSTPRI1       IO_ADDRESS(0x01C14114) 
#define SYSCFG0_MSTPRI2       IO_ADDRESS(0x01C14118) 
#define SYSCFG0_PINMUX0       IO_ADDRESS(0x01C14120) 
#define SYSCFG0_PINMUX1       IO_ADDRESS(0x01C14124) 
#define SYSCFG0_PINMUX2       IO_ADDRESS(0x01C14128) 
#define SYSCFG0_PINMUX3       IO_ADDRESS(0x01C1412C) 
#define SYSCFG0_PINMUX4       IO_ADDRESS(0x01C14130) 
#define SYSCFG0_PINMUX5       IO_ADDRESS(0x01C14134) 
#define SYSCFG0_PINMUX6       IO_ADDRESS(0x01C14138) 
#define SYSCFG0_PINMUX7       IO_ADDRESS(0x01C1413C) 
#define SYSCFG0_PINMUX8       IO_ADDRESS(0x01C14140) 
#define SYSCFG0_PINMUX9       IO_ADDRESS(0x01C14144) 
#define SYSCFG0_PINMUX10      IO_ADDRESS(0x01C14148) 
#define SYSCFG0_PINMUX11      IO_ADDRESS(0x01C1414C) 
#define SYSCFG0_PINMUX12      IO_ADDRESS(0x01C14150) 
#define SYSCFG0_PINMUX13      IO_ADDRESS(0x01C14154) 
#define SYSCFG0_PINMUX14      IO_ADDRESS(0x01C14158) 
#define SYSCFG0_PINMUX15      IO_ADDRESS(0x01C1415C) 
#define SYSCFG0_PINMUX16      IO_ADDRESS(0x01C14160) 
#define SYSCFG0_PINMUX17      IO_ADDRESS(0x01C14164) 
#define SYSCFG0_PINMUX18      IO_ADDRESS(0x01C14168) 
#define SYSCFG0_PINMUX19      IO_ADDRESS(0x01C1416C) 
#define SYSCFG0_SUSPSRC       IO_ADDRESS(0x01C14170) 
#define SYSCFG0_CHIPSIG       IO_ADDRESS(0x01C14174) 
#define SYSCFG0_CHIPSIG_CLR   IO_ADDRESS(0x01C14178) 
#define SYSCFG0_CFGCHIP0      IO_ADDRESS(0x01C1417C) 
#define SYSCFG0_CFGCHIP1      IO_ADDRESS(0x01C14180) 
#define SYSCFG0_CFGCHIP3      IO_ADDRESS(0x01C14188) 
#define SYSCFG0_CFGCHIP4      IO_ADDRESS(0x01C1418C) 

/*syscfg1 register address*/                                                     
#define SYSCFG1_VTPIO_CTL     IO_ADDRESS(0x01E2C000) 
#define SYSCFG1_DDR_SLEW      IO_ADDRESS(0x01E2C004) 
#define SYSCFG1_DEEPSLEEP     IO_ADDRESS(0x01E2C008) 
#define SYSCFG1_PUPD_ENA      IO_ADDRESS(0x01E2C00C) 
#define SYSCFG1_PUPD_SEL      IO_ADDRESS(0x01E2C010) 
#define SYSCFG1_RXACTIVE      IO_ADDRESS(0x01E2C014)  

/*syscfg0 register bit*/
#define SYSCFG0_CFGCHIP1_TBCLKSYNC      (1 << 12)

/*ePWM1 register address start*/
#define EHRPWM1_BASE  		0x01F02000
#define EHRPWM1_TBCTL 		IO_ADDRESS(EHRPWM1_BASE)+0x00
#define EHRPWM1_TBSTS 		IO_ADDRESS(EHRPWM1_BASE)+0x02
#define EHRPWM1_TBPHSHR 	IO_ADDRESS(EHRPWM1_BASE)+0x04
#define EHRPWM1_TBPHS 		IO_ADDRESS(EHRPWM1_BASE)+0x06
#define EHRPWM1_TBCNT 		IO_ADDRESS(EHRPWM1_BASE)+0x08
#define EHRPWM1_TBPRD 		IO_ADDRESS(EHRPWM1_BASE)+0x0A
#define EHRPWM1_CMPCTL 		IO_ADDRESS(EHRPWM1_BASE)+0x0E
#define EHRPWM1_CMPAHR 		IO_ADDRESS(EHRPWM1_BASE)+0x10
#define EHRPWM1_CMPA 		IO_ADDRESS(EHRPWM1_BASE)+0x12
#define EHRPWM1_CMPB 		IO_ADDRESS(EHRPWM1_BASE)+0x14
#define EHRPWM1_AQCTLA  	IO_ADDRESS(EHRPWM1_BASE)+0x16
#define EHRPWM1_AQCTLB 		IO_ADDRESS(EHRPWM1_BASE)+0x18
#define EHRPWM1_AQSFRC 		IO_ADDRESS(EHRPWM1_BASE)+0x1A
#define EHRPWM1_AQCSFRC 	IO_ADDRESS(EHRPWM1_BASE)+0x1C
#define EHRPWM1_DBCTL 		IO_ADDRESS(EHRPWM1_BASE)+0x1E
#define EHRPWM1_DBRED 		IO_ADDRESS(EHRPWM1_BASE)+0x20
#define EHRPWM1_DBFED 		IO_ADDRESS(EHRPWM1_BASE)+0x22
#define EHRPWM1_PCCTL 		IO_ADDRESS(EHRPWM1_BASE)+0x3C
#define EHRPWM1_TZSEL 		IO_ADDRESS(EHRPWM1_BASE)+0x24
#define EHRPWM1_TZCTL 		IO_ADDRESS(EHRPWM1_BASE)+0x28

/*ePWM0 register address*/
...
#define DA8XX_ECAP0_BASE        IO_ADDRESS(0x01F06000)
#define DA8XX_ECAP1_BASE        IO_ADDRESS(0x01F07000)
#define DA8XX_ECAP2_BASE        IO_ADDRESS(0x01F08000)
...
// 64位定时器p0基址
#define AM1808_TIMER64P0_BASE	IO_ADDRESS(0x01c20000)
// 64位定时器p1基址
#define AM1808_TIMER64P1_BASE	IO_ADDRESS(0x01c21000)
#define AM1808_TIMER64P2_BASE	IO_ADDRESS(0x01f0c000)
#define AM1808_TIMER64P3_BASE	IO_ADDRESS(0x01f0d000)

// timer 0
#define TIMER64P0_REVID         (AM1808_TIMER64P0_BASE + 0x00)   
#define TIMER64P0_EMUMGT        (AM1808_TIMER64P0_BASE + 0x04)    
#define TIMER64P0_GPINTGPEN     (AM1808_TIMER64P0_BASE + 0x08)    
#define TIMER64P0_GPDATGPDIR    (AM1808_TIMER64P0_BASE + 0x0C)    
#define TIMER64P0_TIM12         (AM1808_TIMER64P0_BASE + 0x10)    
#define TIMER64P0_TIM34         (AM1808_TIMER64P0_BASE + 0x14)    
#define TIMER64P0_PRD12         (AM1808_TIMER64P0_BASE + 0x18)    
#define TIMER64P0_PRD34         (AM1808_TIMER64P0_BASE + 0x1C)    
#define TIMER64P0_TCR           (AM1808_TIMER64P0_BASE + 0x20)    
#define TIMER64P0_TGCR          (AM1808_TIMER64P0_BASE + 0x24)    
#define TIMER64P0_WDTCR         (AM1808_TIMER64P0_BASE + 0x28)    
#define TIMER64P0_REL12         (AM1808_TIMER64P0_BASE + 0x34)    
#define TIMER64P0_REL34         (AM1808_TIMER64P0_BASE + 0x38)    
#define TIMER64P0_CAP12         (AM1808_TIMER64P0_BASE + 0x3C)    
#define TIMER64P0_CAP34         (AM1808_TIMER64P0_BASE + 0x40)    
#define TIMER64P0_INTCTLSTAT    (AM1808_TIMER64P0_BASE + 0x44)    
#define TIMER64P0_CMP0          (AM1808_TIMER64P0_BASE + 0x60)    
#define TIMER64P0_CMP1          (AM1808_TIMER64P0_BASE + 0x64)    
#define TIMER64P0_CMP2          (AM1808_TIMER64P0_BASE + 0x68)    
#define TIMER64P0_CMP3          (AM1808_TIMER64P0_BASE + 0x6C)    
#define TIMER64P0_CMP4          (AM1808_TIMER64P0_BASE + 0x70)    
#define TIMER64P0_CMP5          (AM1808_TIMER64P0_BASE + 0x74)    
#define TIMER64P0_CMP6          (AM1808_TIMER64P0_BASE + 0x78)    
#define TIMER64P0_CMP7          (AM1808_TIMER64P0_BASE + 0x7C)    


// timer 1
#define TIMER64P1_REVID         (AM1808_TIMER64P1_BASE + 0x00)  
#define TIMER64P1_EMUMGT        (AM1808_TIMER64P1_BASE + 0x04)   
#define TIMER64P1_GPINTGPEN     (AM1808_TIMER64P1_BASE + 0x08)   
#define TIMER64P1_GPDATGPDIR    (AM1808_TIMER64P1_BASE + 0x0C)   
#define TIMER64P1_TIM12         (AM1808_TIMER64P1_BASE + 0x10)   
#define TIMER64P1_TIM34         (AM1808_TIMER64P1_BASE + 0x14)   
#define TIMER64P1_PRD12         (AM1808_TIMER64P1_BASE + 0x18)   
#define TIMER64P1_PRD34         (AM1808_TIMER64P1_BASE + 0x1C)   
#define TIMER64P1_TCR           (AM1808_TIMER64P1_BASE + 0x20)   
#define TIMER64P1_TGCR          (AM1808_TIMER64P1_BASE + 0x24)   
#define TIMER64P1_WDTCR         (AM1808_TIMER64P1_BASE + 0x28)   
#define TIMER64P1_REL12         (AM1808_TIMER64P1_BASE + 0x34)   
#define TIMER64P1_REL34         (AM1808_TIMER64P1_BASE + 0x38)   
#define TIMER64P1_CAP12         (AM1808_TIMER64P1_BASE + 0x3C)   
#define TIMER64P1_CAP34         (AM1808_TIMER64P1_BASE + 0x40)   
#define TIMER64P1_INTCTLSTAT    (AM1808_TIMER64P1_BASE + 0x44)   
#define TIMER64P1_CMP0          (AM1808_TIMER64P1_BASE + 0x60)   
#define TIMER64P1_CMP1          (AM1808_TIMER64P1_BASE + 0x64)   
#define TIMER64P1_CMP2          (AM1808_TIMER64P1_BASE + 0x68)   
#define TIMER64P1_CMP3          (AM1808_TIMER64P1_BASE + 0x6C)   
#define TIMER64P1_CMP4          (AM1808_TIMER64P1_BASE + 0x70)   
#define TIMER64P1_CMP5          (AM1808_TIMER64P1_BASE + 0x74)   
#define TIMER64P1_CMP6          (AM1808_TIMER64P1_BASE + 0x78)   
#define TIMER64P1_CMP7          (AM1808_TIMER64P1_BASE + 0x7C)   


// timer 2
#define TIMER64P2_REVID         (AM1808_TIMER64P2_BASE + 0x00) 
#define TIMER64P2_EMUMGT        (AM1808_TIMER64P2_BASE + 0x04)
#define TIMER64P2_GPINTGPEN     (AM1808_TIMER64P2_BASE + 0x08)
#define TIMER64P2_GPDATGPDIR    (AM1808_TIMER64P2_BASE + 0x0C)
#define TIMER64P2_TIM12         (AM1808_TIMER64P2_BASE + 0x10)
#define TIMER64P2_TIM34         (AM1808_TIMER64P2_BASE + 0x14)
#define TIMER64P2_PRD12         (AM1808_TIMER64P2_BASE + 0x18)
#define TIMER64P2_PRD34         (AM1808_TIMER64P2_BASE + 0x1C)
#define TIMER64P2_TCR           (AM1808_TIMER64P2_BASE + 0x20)
#define TIMER64P2_TGCR          (AM1808_TIMER64P2_BASE + 0x24)
#define TIMER64P2_WDTCR         (AM1808_TIMER64P2_BASE + 0x28)
#define TIMER64P2_REL12         (AM1808_TIMER64P2_BASE + 0x34)
#define TIMER64P2_REL34         (AM1808_TIMER64P2_BASE + 0x38)
#define TIMER64P2_CAP12         (AM1808_TIMER64P2_BASE + 0x3C)
#define TIMER64P2_CAP34         (AM1808_TIMER64P2_BASE + 0x40)
#define TIMER64P2_INTCTLSTAT    (AM1808_TIMER64P2_BASE + 0x44)
#define TIMER64P2_CMP0          (AM1808_TIMER64P2_BASE + 0x60)
#define TIMER64P2_CMP1          (AM1808_TIMER64P2_BASE + 0x64)
#define TIMER64P2_CMP2          (AM1808_TIMER64P2_BASE + 0x68)
#define TIMER64P2_CMP3          (AM1808_TIMER64P2_BASE + 0x6C)
#define TIMER64P2_CMP4          (AM1808_TIMER64P2_BASE + 0x70)
#define TIMER64P2_CMP5          (AM1808_TIMER64P2_BASE + 0x74)
#define TIMER64P2_CMP6          (AM1808_TIMER64P2_BASE + 0x78)
#define TIMER64P2_CMP7          (AM1808_TIMER64P2_BASE + 0x7C)

// timer3
#define TIMER64P3_REVID         (AM1808_TIMER64P3_BASE + 0x00)     
#define TIMER64P3_EMUMGT        (AM1808_TIMER64P3_BASE + 0x04)      
#define TIMER64P3_GPINTGPEN     (AM1808_TIMER64P3_BASE + 0x08)      
#define TIMER64P3_GPDATGPDIR    (AM1808_TIMER64P3_BASE + 0x0C)      
#define TIMER64P3_TIM12         (AM1808_TIMER64P3_BASE + 0x10)      
#define TIMER64P3_TIM34         (AM1808_TIMER64P3_BASE + 0x14)      
#define TIMER64P3_PRD12         (AM1808_TIMER64P3_BASE + 0x18)      
#define TIMER64P3_PRD34         (AM1808_TIMER64P3_BASE + 0x1C)      
#define TIMER64P3_TCR           (AM1808_TIMER64P3_BASE + 0x20)      
#define TIMER64P3_TGCR          (AM1808_TIMER64P3_BASE + 0x24)      
#define TIMER64P3_WDTCR         (AM1808_TIMER64P3_BASE + 0x28)      
#define TIMER64P3_REL12         (AM1808_TIMER64P3_BASE + 0x34)      
#define TIMER64P3_REL34         (AM1808_TIMER64P3_BASE + 0x38)      
#define TIMER64P3_CAP12         (AM1808_TIMER64P3_BASE + 0x3C)      
#define TIMER64P3_CAP34         (AM1808_TIMER64P3_BASE + 0x40)      
#define TIMER64P3_INTCTLSTAT    (AM1808_TIMER64P3_BASE + 0x44)      
#define TIMER64P3_CMP0          (AM1808_TIMER64P3_BASE + 0x60)      
#define TIMER64P3_CMP1          (AM1808_TIMER64P3_BASE + 0x64)      
#define TIMER64P3_CMP2          (AM1808_TIMER64P3_BASE + 0x68)      
#define TIMER64P3_CMP3          (AM1808_TIMER64P3_BASE + 0x6C)      
#define TIMER64P3_CMP4          (AM1808_TIMER64P3_BASE + 0x70)      
#define TIMER64P3_CMP5          (AM1808_TIMER64P3_BASE + 0x74)      
#define TIMER64P3_CMP6          (AM1808_TIMER64P3_BASE + 0x78)      
#define TIMER64P3_CMP7          (AM1808_TIMER64P3_BASE + 0x7C)      
