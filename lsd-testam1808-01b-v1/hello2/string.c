...
#if defined(ccs)
long
NumLeadingZeros(long lWord)
{
    __asm("    clz     r0, r0\n"
          "    bx      lr\n");
    //
    // The above lines of code perform the function.  The following statement
    // keeps the TI compiler from optimizing this function away.  It will not
    // be executed.
    //
    return(++lWord);
}
