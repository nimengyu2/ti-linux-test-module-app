...
printf("<img src=\"../logo/logo.gif\" width=\"237\" height=\"72\" border=\"0\" align=\"middle\" />\n");
printf("</samp>\n");
printf("</a>\n");
printf("</td>\n");
...
printf("Serial to WIFI Module\n");
printf("<br>\n");
printf("LSD-S2WIFI_V1.0\n");
printf("</h5>\n");
printf("<p class=\"STYLE10\">\n");
printf("<span title=\"Reset S2WIFI module. Reboot will take a few seconds, usually is 30s.\">\n");
printf("<input type=\"submit\" class=\"btn\" onClick=\"do_module_reset();\" value=\"AP  >>>  STA\">\n");
printf("</p>\n");
printf("</div>\n");
printf("</td>\n");
printf("</tr>\n");
...
printf("<td>\n");
printf("<h3 class=\"box\">\n");
printf("WIFI Port Configure\n");
printf("</h3>\n");
printf("<span title=\"Save new WIFI port configure\">\n");
printf("<input type=\"submit\" id=\"wifibtn\" class=\"button\" value=\"Update\" onClick=\"do_wifi_apply();\">\n");
printf("</span>\n");
printf("<span title=\"Reset WIFI port configure\">\n");
printf("<input type=\"submit\" class=\"button\" value=\"Reset\" onClick=\"do_wifi_reset();\">\n");
printf("</span>\n");
printf("<hr width=\"778\" size=\"4\" />\n");
printf("</td>\n");
printf("</tr>\n");
...
printf("Local Socket Port Number: \n");
printf("</span>\n");
printf("</td>\n");
printf("<td>\n");
...
printf("Remote Socket Port Number: \n");
printf("</span>\n");
printf("</td>\n");
printf("<td>\n");
...
printf("<td>\n");
printf("<h3 class=\"box\">\n");
printf("Serial Port Configure\n");
printf("</h3>\n");
printf("<span title=\"Save new Serial port configure\">\n");
printf("<input type=\"submit\" id=\"serialbtn\" class=\"button\" value=\"Update\" onClick=\"do_serial_apply();\">\n");
printf("</span>\n");
printf("<span title=\"Reset Serial port configure\">\n");
printf("<input type=\"submit\" class=\"button\" value=\"Reset \" onClick=\"do_serial_reset();\">\n");
printf("</span>\n");
printf("<hr width=\"778\" size=\"4\" />\n");
printf("</td>\n");
printf("</tr>\n");
printf("<tr>\n");
printf("<td>\n");
printf("<form name=\"serial\" method=\"get\" action=\"serial.cgi\">\n");
printf("<table width=\"100%\" border=\"0\" cellpadding=\"2\" cellspacing=\"2\">\n");
printf("<tbody>\n");
printf("<tr>\n");
printf("<td width=\"30%\" class=\"gr\">\n");
...
printf("<tr>\n");
printf("<td class=\"gr\">\n");
printf("<span title=\"Serial port baud rate.\">\n");
printf("Baud Rate: \n");
printf("</span>\n");
printf("</td>\n");
printf("<td>\n");
printf("<a name=\"pbaudrate\" id=\"pbaudrate\">\n");
printf("</a>\n");
printf("bits/second\n");
printf("</td>\n");
printf("<td>\n");
printf("<select name=\"baudrate\" size=\"1\" class=\"list\">\n");
printf("<option value=\"230400\">\n");
printf("230400\n");
printf("</option>\n");
printf("<option value=\"115200\">\n");
printf("115200\n");
printf("</option>\n");
printf("<option value=\"57600\">\n");
printf("57600\n");
printf("</option>\n");
printf("<option value=\"38400\">\n");
printf("38400\n");
printf("</option>\n");
printf("<option value=\"19200\">\n");
printf("19200\n");
printf("</option>\n");
printf("<option value=\"14400\">\n");
printf("14400\n");
printf("</option>\n");
printf("<option value=\"9600\">\n");
printf("9600\n");
printf("</option>\n");
printf("<option value=\"4800\">\n");
printf("4800\n");
printf("</option>\n");
printf("<option value=\"2400\">\n");
printf("2400\n");
printf("</option>\n");
...
printf("<tr>\n");
printf("<td class=\"gr\">\n");
printf("<span title=\"Serial port data size.\">\n");
printf("Data Size:\n");
printf("</span>\n");
printf("</td>\n");
printf("<td>\n");
printf("<a name=\"pdatasize\" id=\"pdatasize\">\n");
printf("</a>\n");
printf(" bits/character\n");
printf("</td>\n");
printf("<td>\n");
printf("<select name=\"datasize\" size=\"1\" class=\"list\">\n");
...
printf("<tr>\n");
printf("<td class=\"gr\">\n");
printf("<span title=\"Serial port parity.\">\n");
printf("Parity: \n");
printf("</span>\n");
printf("</td>\n");
printf("<td>\n");
printf("<a name=\"pparity\" id=\"pparity\">\n");
printf("</a>\n");
printf("</td>\n");
printf("<td>\n");
printf("<select name=\"parity\" class=\"list\">\n");
printf("<option value=\"0\">\n");
printf("None\n");
printf("</option>\n");
printf("<option value=\"1\">\n");
...
printf("<tr>\n");
printf("<td class=\"gr\">\n");
printf("<span title=\"Serial port stop bits.\">\n");
printf("Stop Bits: \n");
printf("</span>\n");
printf("</td>\n");
printf("<td>\n");
...
printf("</td>\n");
printf("<td>\n");
printf("<select name=\"stop\" size=\"1\" class=\"list\">\n");
printf("<option value=\"1\">\n");
printf("1\n");
printf("</option>\n");
printf("<option value=\"2\">\n");
...
printf("<tr>\n");
printf("<td class=\"gr\">\n");
printf("<span title=\"Serial port flow control.\">\n");
printf("Flow Control: \n");
printf("</span>\n");
printf("</td>\n");
printf("<td>\n");
...
printf("</td>\n");
printf("<td>\n");
printf("<select name=\"flow\" size=\"1\" class=\"list\">\n");
printf("<option value=\"0\">\n");
printf("None\n");
printf("</option>\n");
printf("<option value=\"1\">\n");
...
printf("2011 (C) Copyright \n");
printf("<a href=\"http://www.lierda.com\" target=\"_blank\">\n");
printf("www.lierda.com\n");
printf("</a>\n");
