...
*@return  void
*/
int speed_arr[] = {B230400,B115200,B57600,B38400,B19200,B9600,B4800,B2400,B1200, B600,B300,B110};
int name_arr[] = {   230400,  115200,   57600,  38400,  19200,  9600,  4800,   2400,  1200,   600,  300,  110};
...
int fn_init_uart0(char *dev,int baudrate,int databits,int stopbits,int parity)
{
	//char *dev  = "/dev/ttyO1"; 
	uart0_tv.tv_sec = 0;
	uart0_tv.tv_usec = 0;
